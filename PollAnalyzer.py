...
class PollAnalyzer:
    ...
    def __init__(self):
        ...
        for file in glob.glob(path2 + "*.xls"):  # parameter should change to (path2+"*.txt")
    ...
    def calcQuestionStat(self):
        ...
        for key in self.__pollList:
            ...
            questions = [x.getQuestion().getQuestionText() for x in
                         self.__pollList[key][0].getQuizes()[i].getQuizParts()]
            answers = []
